...
5. 等待web子目录枚举和虚拟主机名枚举期间检查一下目标web站点的功能。
   ...
   ![image-20231029183528973](Appsanity.assets/image-20231029183528973.png)
...
6. 登陆成功后发现当前用户的cookie中存在JWT，这里的aud参数似乎是用户身份标识。尝试对抗JWT来伪造其他用户，但是并不知道其他用户身份，简单尝试了几次失败后暂时放弃。
   ...
   ![image-20231029185358429](Appsanity.assets/image-20231029185358429.png)
...
4. 在url中访问portal.meddigi.htb是一个登录页面，使用之前注册的凭证登录，没有成功。
   ...
   ![image-20231029200830185](Appsanity.assets/image-20231029200830185.png)
...
5. 枚举portal.meddigi.htb的web子目录没有找到注册页面，只在meddigi.htb上有注册功能。
   ...
   ![image-20231029205650657](Appsanity.assets/image-20231029205650657.png)

6. 使用获取了docker身份的凭证无法登录http://portal.meddigi.htb ,但是发现了该页面的存在cookie

   ![image-20231029205839297](Appsanity.assets/image-20231029205839297.png)

   将在http://medigi.htb页面上注册成docker的cookie复制到http://portal.meddigi.htb中，成功登录

   ![image-20231029210335680](Appsanity.assets/image-20231029210335680.png)

   

7. 发现一个文件上传功能点，还贴心的回显了文件存储路径，尝试后告知只能上传PDF文件。

   ![image-20231029210616702](Appsanity.assets/image-20231029210616702.png)
...
8. 发现该页面存在SSRF漏洞。
   ...
   ![image-20231029211549682](Appsanity.assets/image-20231029211549682.png)
   ...
   ![image-20231029215902579](Appsanity.assets/image-20231029215902579.png)
...
2. 现在的攻击思路大致是
   ...
   ![image-20231030104531393](Appsanity.assets/image-20231030104531393.png)
...
1. 首先利用winPEASany.exe来枚举收集一下基本信息
   ...
   ![image-20231030120434569](Appsanity.assets/image-20231030120434569.png)
